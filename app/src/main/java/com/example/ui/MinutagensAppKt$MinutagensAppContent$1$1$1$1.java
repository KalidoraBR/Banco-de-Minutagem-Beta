...
@DebugMetadata(c = "com.example.ui.MinutagensAppKt$MinutagensAppContent$1$1$1$1", f = "MinutagensApp.kt", i = {0, 0}, l = {195}, m = "invokeSuspend", n = {"currentSeries", "apiCfg"}, s = {"L$0", "L$1"})
/* loaded from: classes11.dex */
public final class MinutagensAppKt$MinutagensAppContent$1$1$1$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public MinutagensAppKt$MinutagensAppContent$1$1$1$1(Context context, Continuation<? super MinutagensAppKt$MinutagensAppContent$1$1$1$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new MinutagensAppKt$MinutagensAppContent$1$1$1$1(this.$context, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((MinutagensAppKt$MinutagensAppContent$1$1$1$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
